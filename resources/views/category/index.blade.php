...
@section('content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      ...
      <a href="{{route('categories.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add plat"><i class="fas fa-plus"></i> Add Category</a>
    </div>
    <div class="card-body">
          ...
          <tbody>
            @foreach($categories as $categorie)   
                <tr>
                    ...
                    <td>
                      <a href="{{route('categories.edit',$categorie->id)}}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="edit" data-placement="bottom"><i class="fas fa-edit"></i></a>
